...
// This is only suitable for protocol/ppi mocks.
//
...
//
// Stub function definition for gAL_AdvancedLoggerPrintPpi to use C standard VA_LIST.
// Otherwise GCC compiler throws ignored-attributes warning when using in C++ Gmock.
//
extern "C" {
  VOID
  EFIAPI
